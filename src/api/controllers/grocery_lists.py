...
# from src.api.schemas.user import IngredientsCreate
...
WE STILL NEED THE MODEL BUT THIS IS A TEMPLATE

JUST CHANGE THE IMPORT INGREDIENT
AND THE WHATS BEING IMPORTED FROM BELOW
